...
Descriptions: the code to train and run the gaussRNN from dl4s.autoregRNN
              ...
              ----2017.11.03
#########################################################################"""
from dl4s import gaussRNN_cov, configRNN
...
if __name__ == '__main__':
    ...
    if Flag == 'training':
        ...
        RNN = gaussRNN_cov(configRNN)
        RNN.full_train(dataset=Dataset, maxEpoch=300, batchSize= 75, earlyStop=10, learning_rate=0.0001,
